...
public class DungeonManager {
    ...
    public void onReceiveChat(ClientChatReceivedEvent event) {
        ...
        else if (message.startsWith("§r§c[BOSS] The Watcher§r§f: You have proven yourself. You may pass.§r")) bloodTime = System.currentTimeMillis() + 5000; //5 seconds because additional messages might come through

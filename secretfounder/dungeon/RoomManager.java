...
public class RoomManager {
	        ...
	        if (gameStage == 2) {
	            ...
	            if (stage2Ticks > 2 && futureUpdatePossibleRooms != null && futureUpdatePossibleRooms.isDone()) {
	                try {
	                    ...
	                    else incompleteScan = System.currentTimeMillis() + 1000;
    ...
    void updateCurrentRoom() {
        ...
        roomColor = MapUtils.getMapColor(currentMapCorner, map); if (roomColor.equals("undefined")) return;
        ...
        return stage2Executor.submit(() -> {
            ...
            if (possibleRooms == null) {
                ...
                for (String direction : possibleDirections) {
                    updatedPossibleRooms.put(direction, new ArrayList<>(SecretFounder.ROOM_DATA.get(roomCategory).keySet()));
                }
            } 
            else {

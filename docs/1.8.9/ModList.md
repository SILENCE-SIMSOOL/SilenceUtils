...
| [Secret Founder](https://github.com/SILENCE-SIMSOOL/SilenceUtils-Documentation/blob/main/docs/secretfounder/INFO.md) | 시크릿 파운더는 [Dungeon Rooms](https://github.com/Quantizr/DungeonRoomsMod) 모드를 기반으로 만들어진 필자의 또 다른 모드였습니다. 현재는 업데이트를 중단하고 이전 던전룸스의 구식방식을 모두 버렸으며 사일런스 유틸에 내장되어 새롭게 개발되고 있습니다. 시크릿 파운더의 장점은 효율적인 연산으로 반응과 성능이 매우 뛰어나며 세련된 디자인으로 화면을 더럽히지 않고 깔끔합니다. 또한 많은 카테고리들이 존재하며 이를 유저들이 쉽게 추가하고 커스터마이징 할 수 있도록 사용자 친화적인 설정방식을 제공합니다. |

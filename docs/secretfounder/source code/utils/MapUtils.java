...
public class MapUtils {
	...
	public static boolean mapExists() {
		...
		ItemStack mapSlot = mc.thePlayer.inventory.getStackInSlot(8); if (mapSlot == null || mapSlot.getItem() != Items.filled_map || !mapSlot.hasDisplayName()) return false;
	...
	public static List<Point> neighboringSegments(Point originCorner, Integer[][] map, Point leftCorner,
		Point rightCorner, List<Point> list) {
	...
	public static String roomCategory(String roomSize, String roomColor) {
		...
		} else return roomSize;
	}

	public static Point playerMarkerPos() {
		MapData mapData = (MapData) mc.theWorld.getMapStorage().loadData(MapData.class, "map_" + DungeonManager.mapId); if (mapData == null) return null;

...
public class SecretFounder {
	...
	public void onTick(TickEvent.ClientTickEvent event) {
		if (!Config.SecretFounder || event.phase != TickEvent.Phase.START || mc.thePlayer == null) return;
		tickAmount++;
		int t = (Config.RoomDetectPerformance == 0) ? 65 : 45; if (Config.RoomDetectPerformance == 2) t = 28;
		if (tickAmount % t == 0) {

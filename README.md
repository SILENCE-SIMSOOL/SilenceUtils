...
| 상황               | 클라이언트       | 모드                                                                             |
|--------------------|------------------|-----------------------------------------------------------------------------------|
| 일반               | 페더              | Silence Utils, MeowMap                                                           |
| 일반               | 포지              | Silence Utils, MeowMap, Scrollable Tooltips, Chatting, VanillaHUD                |
| 다이에나, 리프트   | 페더              | Silence Utils, MeowMap, Neu, Skyhanni                                            |
| 일반               | 포지              | Silence Utils, MeowMap, Neu, Skyhannim Scrollable Tooltips, Chatting, VanillaHUD |

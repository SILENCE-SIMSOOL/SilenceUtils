<p align="center">
	...
	<a href="https://discord.gg/2Zt8HDksJs" target="_blank">
		<img alt="discord" src="https://img.shields.io/discord/2Zt8HDksJs?color=4166f5&label=discord&style=flat-square" />
	</a>
</p>
...
프라이베잇 모드로 공유될 동안 유사한 모드들이 나타날 것은 예상했지만, 소스코드를 **무단으로 사용하며** 자신들의 모드라고 우기는 경우들이 있었기에 안내드립니다.
...
## 🚀 모드 구매하기
1. [디스코드 서버](https://discord.gg/2Zt8HDksJs)에 가입해주세요.  
2. 구매하기(Purchase) 채널에서 **결제 방법**과 **옵션 사항**들을 입력 후 구매 티켓을 열어주세요.  
...
3. 구매처리가 완료되면 **서버내의 역할**을 지급받고, 지침사항과 함께 **모드를 다이렉트 메세지**로 보내드립니다.  
3-1. 서버 멤버가 보내는 다이렉트 메세지를 허용해주시거나 SILENCE 봇 앱 추가를 눌러 허용해주세요.  
4. 모드를 다운로드 받아 **모드 폴더**에 넣고 **게임을 실행**해주세요.  
5. 처음 실행시 관리자의 **인증 승인**을 기다리셔야 합니다.  
5-1. 구매 후 5분에서 10분 사이로 게임을 실행하실 경우 빠른 승인이 가능합니다.  
5-2. 인증 승인 시간은 최소 1분에서 최대 24시간이 걸릴 수 있습니다.  

## ❗ 사용 및 구매하기 전 유의사항
① 사일런스 유틸은 핵과 관련한 기능을 제작하지 않습니다.  
② 서버에서 밴이 되었을 때 해당 모드를 사용했어도 사일런스 모드에 의한 것인지 확인할 수 없으며 모드 사용 책임은 사용자에게 있습니다.  
③ 모드를 구매하면 영구적으로 사용 가능하며 마인크래프트 계정 제한 없이 사용 가능합니다.  
④ 모드 구매가 완료된 후 환불 요청을 할 수 없습니다.  
⑤ 모드를 제3자 혹은 공공장소에 공유하다 적발 시 모드 사용이 중지되며 블랙리스트에 올라갑니다.  
